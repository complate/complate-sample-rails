...
function DemoIndex(_ref) {
	...
	return createElement(
		...
		" (Make sure your server supports this...)"
	);
}

function DemoStreaming(_ref) {
	...
	return createElement(
		...
		createElement(
			"h1",
			null,
			"Some Streaming for you"
		),
		createElement(
			"p",
			null,
			"Hope you're using puma..."
		),
		function () {
			return sleep();
		},
		createElement(
			"p",
			null,
			"We won't let you wait for too long."
		),
		function () {
			return sleep();
		},
...
function DemoError() {
   return createElement(
      ...
      createElement(
         "h1",
         null,
         "This site contains an error"
      ),
      createElement(BadJSXError, null)
   );
}
